...
<div class="modal">
	<div class="modal-box">
		...
		<div class="py-4">
			<p>
				The essay feedback provided by Fauna is generated using GPT-4, an advanced language model
			...
			<ol>
				...
				<li>
					...
					and quality of your essay lies with you as the student. Fauna, including the feedback generated
			...
			<p class="py-4">
				By using Fauna and availing yourself of the essay feedback provided by GPT-4, you
